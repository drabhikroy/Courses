...
loc <- here::here("static", "handouts", "EDP612Week11Materials.zip")

downloadthis::download_file(
  path = loc,
  output_name = "Week 11 Presentation Materials",
...
knitr::include_url("/slides/Week 11/Slides-Week-11-pres.html")
```
</div>
...
html_link <- function() {
  paste0("<a href='/slides/Week 11/Slides-Week-11-pres.html'>", "<img src='/logos/web-ico.png' alt='Survey Design Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 11/Slides-Week-11-flat.pdf'>", "<img src='/logos/pdf-ico.png' alt='Survey Design PDF' width='35'>", "</a>")
}
