...
html_link <- function() {
  paste0("<a href='/slides/Week 4/Slides-Week-4.html'>", "<img src='/logos/web-ico.png' alt='Starting Research Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 4/Slides-Week-4.pdf'>", "<img src='/logos/pdf-ico.png' alt='Starting Research PDF' width='35'>", "</a>")
}
