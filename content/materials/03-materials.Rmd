...
Download a copy of everything you need for this week^[You will have to unzip this file. If you are unfamiliar with this process, please check the [Unzipping files](/resources/unzipping/) section under Resources for assistance]

<center>
```{r echo=FALSE,eval=TRUE,message=FALSE,purl=FALSE}
loc <- here::here("static", "slides", "Week 3", "EDP612Week3Materials.zip")
...
knitr::include_url("/slides/Week 3/Slides-Week-3s.html")
```
</div>
...
html_link <- function() {
  paste0("<a href='/slides/Week 3/Slides-Week-3s.html'>", "<img src='/logos/web-ico.png' alt='Ethics Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 3/Slides-Week-3.pdf'>", "<img src='/logos/pdf-ico.png' alt='Ethics PDF' width='35'>", "</a>")
}
