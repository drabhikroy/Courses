...
knitr::include_url("/slides/Week 1/Slides-Week-1b.html")
```
</div>
...
html_link <- function() {
  paste0("<a href='/slides/Week 1/Slides-Week-1.html'>", "<img src='/logos/web-ico.png' alt='Theory & Terminology Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 1/Slides-Week-1.pdf'>", "<img src='/logos/pdf-ico.png' alt='Theory & Terminology PDF' width='35'>", "</a>")
}
