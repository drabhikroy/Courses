...
knitr::include_url("/slides/Week 5/Slides-Week-5.html")
```
</div>
...
html_link <- function() {
  paste0("<a href='/slides/Week 5/Slides-Week-5.html'>", "<img src='/logos/web-ico.png' alt='QED Intro Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 5/Slides-Week-5.pdf'>", "<img src='/logos/pdf-ico.png' alt='QED Intro PDF' width='35'>", "</a>")
}
