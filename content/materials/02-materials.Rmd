...
loc <- here::here("static", "slides", "Week 2", "EDP612Week2Materials.zip")
...
html_link <- function() {
  paste0("<a href='/slides/Week 2/Slides-Week-2.html'>", "<img src='/logos/web-ico.png' alt='Selection & Detecting Topics Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 2/Slides-Week-2.pdf'>", "<img src='/logos/pdf-ico.png' alt='Selection & Detecting Topics PDF' width='35'>", "</a>")
}
