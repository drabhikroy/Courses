...
knitr::include_url("/slides/Week 7/Slides-Week-7a-pres.html")
```
</div>
...
html_link <- function() {
  paste0("<a href='/slides/Week 7/Slides-Week-7a-pres.html'>", "<img src='/logos/web-ico.png' alt='QED Intro Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 7/Slides-Week-7a-flat.pdf'>", "<img src='/logos/pdf-ico.png' alt='QED Intro PDF' width='35'>", "</a>")
}
...
<div class="box">
```{r echo = FALSE, out.width="185%", fig.align='left'}
knitr::include_url("/slides/Week 7/Slides-Week-7b-pres.html")
```
</div>
...
```{r echo = FALSE, fig.align='right'}
html_link <- function() {
  paste0("<a href='/slides/Week 7/Slides-Week-7b-pres.html'>", "<img src='/logos/web-ico.png' alt='QED Intro Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 7/Slides-Week-7b-flat.pdf'>", "<img src='/logos/pdf-ico.png' alt='QED Intro PDF' width='35'>", "</a>")
}
