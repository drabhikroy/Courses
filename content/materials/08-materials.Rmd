...
<div class="box">
```{r echo = FALSE, out.width="185%", fig.align='left'}
...
html_link <- function() {
  paste0("<a href='/slides/Week 8/Slides-Week-8a-pres.html'>", "<img src='/logos/web-ico.png' alt='QED Intro Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 8/Slides-Week-8a-flat.pdf'>", "<img src='/logos/pdf-ico.png' alt='QED Intro PDF' width='35'>", "</a>")
}
...
tibble(
  ...
  row_spec(1:11, extra_css = 'vertical-align: middle !important;', color = "#ffffff", background = "transparent")
...
```{r echo = FALSE, fig.align='right'}
html_link <- function() {
  paste0("<a href='/slides/Week 8/Slides-Week-8b-pres.html'>", "<img src='/logos/web-ico.png' alt='QED Intro Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 8/Slides-Week-8b-flat.pdf'>", "<img src='/logos/pdf-ico.png' alt='QED Intro PDF' width='35'>", "</a>")
}
...
```{r echo = FALSE, fig.align='right'}
html_link <- function() {
  paste0("<a href='/slides/Week 8/Slides-Week-8c-pres.html'>", "<img src='/logos/web-ico.png' alt='QED Intro Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 8/Slides-Week-8c-flat.pdf'>", "<img src='/logos/pdf-ico.png' alt='QED Intro PDF' width='35'>", "</a>")
}
