...
loc <- here::here("static", "handouts", "EDP612Week6Materials.zip")

downloadthis::download_file(
  path = loc,
  output_name = "Week 6 Presentation Materials",
...
knitr::include_url("/slides/Week 6/Slides-Week-6a.html")
```
</div>
...
html_link <- function() {
  paste0("<a href='/slides/Week 6/Slides-Week-6a.html'>", "<img src='/logos/web-ico.png' alt='QED Intro Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 6/Slides-Week-6a.pdf'>", "<img src='/logos/pdf-ico.png' alt='QED Intro PDF' width='35'>", "</a>")
}
...
<div class="box">
```{r echo = FALSE, out.width="185%", fig.align='left'}
knitr::include_url("/slides/Week 6/Slides-Week-6b.html")
```
</div>
...
```{r echo = FALSE, fig.align='right'}
html_link <- function() {
  paste0("<a href='/slides/Week 6/Slides-Week-6b.html'>", "<img src='/logos/web-ico.png' alt='QED Intro Page' width='35'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 6/Slides-Week-6b.pdf'>", "<img src='/logos/pdf-ico.png' alt='QED Intro PDF' width='35'>", "</a>")
}
