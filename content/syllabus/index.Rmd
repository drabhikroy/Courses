...
<center>
```{r echo = FALSE}
knitr::include_url("/slides/Week 1/Slides-Week-1a.html")
```
</center>
...
html_link <- function() {
  paste0("<a href='/slides/Week 1/Slides-Week-1a.html'>", "<img src='/logos/web-ico.png' alt='Slack icon' width='30'>", "</a>")
}

pdf_link <- function() {
 paste0("<a href='/slides/Week 1/Slides-Week-1a.pdf'>", "<img src='/logos/pdf-ico.png' alt='Slack icon' width='30'>", "</a>")
}
