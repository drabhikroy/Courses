...
rpack <- 
  ...
  Site = c(
    "https://amcrisan.github.io/adjutant",
    "https://revtools.net/",
    "https://www.semanticscholar.org/"
    )
...
lits %>%
  ...
  column_spec(1, width = "20em") %>%
  column_spec(2, width = "10em") %>%
  row_spec(0:4, extra_css = 'vertical-align: middle !important;', color = "#ffffff", background = "transparent") 
```
</center>
